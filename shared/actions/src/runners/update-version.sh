...
# settings to the current RUNNER_CONTAINER_IMAGE_TAG, accumulating response
# status code counts into RESPONSE_COUNTS.
update_runners() {
  runner_ids="$1"
...
update_runners "$install_runner_ids"
