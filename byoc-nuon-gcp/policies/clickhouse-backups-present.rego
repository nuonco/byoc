...
# scheduled backups to GCS. Shipping the cluster without those backup manifests
...
# ──────────────────────────────────────────────────────────────────────────────
# A deployed ClickHouse cluster must ship its GCS backup manifests.
# ──────────────────────────────────────────────────────────────────────────────
warn contains msg if {
	installation_present
	count(backup_manifests) == 0
	msg := "ClickHouse cluster is being deployed without any backup manifests. The GCS backup CronJobs must be present so telemetry data can be recovered."
}
