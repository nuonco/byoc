Runs every action that populates a section of the install README, so the rendered page reflects current state. Use this
after a deploy, or any time the README looks stale.
