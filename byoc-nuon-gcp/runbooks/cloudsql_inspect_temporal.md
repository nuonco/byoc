Inspects the **Temporal** Cloud SQL instance (`temporal-<install-id>`) and prints, in table format:
...
Use this to size the instance, check storage auto-resize headroom, confirm backups and PITR are enabled, and see what recently changed on the instance before or after a Temporal incident.
