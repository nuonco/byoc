    ...
    spec:
      ...
      containers:
        - name: {{ include "common.fullname" . }}-auth
          ...
          resources:
            limits:
              cpu: {{ .Values.api.auth.resources.limits.cpu | default .Values.api.resources.limits.cpu }}
              memory: {{ .Values.api.auth.resources.limits.memory | default .Values.api.resources.limits.memory }}
            requests:
              cpu: {{ .Values.api.auth.resources.requests.cpu | default .Values.api.resources.requests.cpu }}
              memory: {{ .Values.api.auth.resources.requests.memory | default .Values.api.resources.requests.memory }}
          envFrom:
            - configMapRef:
          ...
          {{- end}}
          {{/* additional secrets only this service will need */}}
