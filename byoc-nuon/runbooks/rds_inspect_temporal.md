...
Use this to size the instance, spot CPU or memory pressure, find what is driving database load, and check IOPS/storage headroom before or after a Temporal incident.
